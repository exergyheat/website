...
const Learn = () => {
  ...
  const concepts = [
    ...
    },
    {
      ...
      icon: Bitcoin,
      description: "Bitcoin mining is a free and open source protocol (like email or the world wide web) that rewards participants for contributing work to process bitcoin transactions. The more energy you contribute, the more you earn.",
