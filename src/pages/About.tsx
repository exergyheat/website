...
const About = () => {
  ...
  const processSteps = [
    ...
    },
    {
      ...
      description: 'Optional remote monitoring ensures your system is always healthy and earning what it should. Because our heaters are digital - we can sense when it is time for a tune up.',
      icon: Monitor,
      preview: {
