  ...
  const processSteps = [
    {
      ...
      subtitle: 'What we recommend, how much you can save, and how much it will cost',
    ...
    },
    {
      ...
      subtitle: 'Get all the parts, organize installation, and bring the system online',
