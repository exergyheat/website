...
const About = () => {
  ...
  const processSteps = [
    ...
    },
    {
      ...
      description: 'When ready, we source the best hashrate heating hardware and coordinate install with partners to bring your system online with smooth integration.',
      icon: Package,
      preview: {
