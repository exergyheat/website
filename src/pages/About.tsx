...
const About = () => {
  ...
  const processSteps = [
    ...
    },
    {
      ...
      description: 'From parts lists and shipping, to scheduling professional installation or hand holding you or a tradesmen throughout the process, we\'ll get your hashrate heating system running.',
      icon: Wrench,
      preview: {
