  ...
  const processSteps = [
    {
      ...
      description: 'We start with thermo-economic modeling to understand your exact your heating needs and calculate predicted earnings. This tells us what hashrate heater is best for you',
      icon: FileText,
      preview: {
    ...
    },
    {
      id: 'design',
      title: 'System Design',
      description: 'Engineering and custom system design follows the Heat Audit. Once we know how much heat you need, and which hashrate heater is best - we design your integrated system',
      icon: Wrench,
      preview: {
