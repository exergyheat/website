        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          <div className="bg-white dark:bg-surface-800 rounded-lg shadow-xl p-8 transform hover:scale-105 transition-transform">
            ...
            <p className="mt-2 text-surface-600 dark:text-surface-400">
              Our founder wrote the first comprehensive book on hashrate heating - Examaning why this technology matters, who can benefit, how to implement it, and provides insights into potential savings.
            </p>
          </div>
          <div className="bg-white dark:bg-surface-800 rounded-lg shadow-xl p-8 transform hover:scale-105 transition-transform">
            <div className="flex justify-center">
