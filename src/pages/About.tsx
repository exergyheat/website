...
import { Book, Users, Award, Cpu, Flame, Bitcoin, ArrowRight, Target, Lightbulb, FileText, ChartBar, Wrench, CheckCircle2 } from 'lucide-react'
      ...
      <div className="bg-white dark:bg-surface-800 py-20">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            <div className="inline-block p-3 bg-primary-100 dark:bg-primary-900 rounded-lg mb-6">
