            ...
            <div className="space-y-8">
              ...
              <div className="flex items-start">
                ...
                <div className="ml-4">
                  ...
                  <p className="mt-2 text-base font-body text-surface-500 dark:text-surface-400">
                    Hashrate Heaters do two things at once: Generate heat by consuming electricity, and generate bitcoin as that electricity is turned to heat. No extra cost.
                  </p>
                </div>
              </div>
            </div>
