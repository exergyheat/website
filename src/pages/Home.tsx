            ...
            <div className="space-y-8">
              ...
              <div className="flex items-start">
                ...
                <div className="ml-4">
                  ...
                  <p className="mt-2 text-base font-body text-surface-500 dark:text-surface-400">
                    Miners perform hashing operations to settle bitcoin transactions and issue coins. Rewards are automated & proportional to the energy used - and all of that energy is all turned into heat.
                  </p>
                </div>
              </div>
              ...
              <div className="flex items-start">
                ...
                <div className="ml-4">
                  ...
                  <p className="mt-2 text-base font-body text-surface-500 dark:text-surface-400">
                    Hashrate Heaters do two things at once: Generate heat by consuming electricity, and generate bitcoin as that electricity is turned to heat. No extra energy or cost.
                  </p>
                </div>
              </div>
            </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="mt-20 grid grid-cols-1 md:grid-cols-3 gap-8">
            ...
            <div className="text-center">
              ...
              <p className="mt-2 font-body text-surface-600 dark:text-surface-400">
                Whatever your heating needs, our custom sizing, engineering designs, and control solutions ensure perfect integration.
              </p>
            </div>
            ...
            <div className="text-center">
              ...
              <p className="mt-2 font-body text-surface-600 dark:text-surface-400">
                Our advanced analysis software matches bitcoin mining power with your custom heat demand for maximum earnings.
              </p>
            </div>
          </div>
