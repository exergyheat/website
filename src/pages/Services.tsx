                  ...
                  <div className={`${(service.exampleImage || service.exampleImages) ? 'flex gap-4' : ''} pt-6 border-t border-surface-200 dark:border-surface-700`}>
                    ...
                    {(service.exampleImage || service.exampleImages) && (
                      <a
                        ...
                        target="_blank"
                        rel="noopener noreferrer"
                        className="px-6 py-3 bg-surface-100 dark:bg-surface-700 text-surface-300 dark:text-surface-100 rounded-lg hover:bg-surface-200 dark:hover:bg-surface-600 transition-colors text-base font-subheading"
                      >
                        Example
                      </a>
                    )}
