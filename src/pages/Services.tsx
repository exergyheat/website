...
const Services = () => {
  ...
  const journeySteps = [
    ...
    },
    {
      ...
      icon: Monitor,
      flipText: 'Start with Remote Monitoring if you already have hashrate heating, and want to get the most out of your system.',
  ...
  const getAuditService = (type: 'residential' | 'commercial') => ({
    ...
    description: "Get a comprehensive analysis of your heating needs. Our Heat Audit tells you everything you need to know about your hashrate heating potential.",
                  ...
                  <div className="absolute inset-0 w-full h-full backface-hidden">
                    <div className="bg-white dark:bg-surface-700 rounded-lg shadow-lg p-6 border-2 border-surface-200 dark:border-surface-600 h-full flex flex-col justify-between cursor-pointer hover:shadow-xl transition-shadow">
                      ...
                      <div className="text-center mt-4">
                        <p className="text-xs text-surface-500 dark:text-surface-400">Flip to see why start here</p>
                      </div>
                    </div>
                  </div>
